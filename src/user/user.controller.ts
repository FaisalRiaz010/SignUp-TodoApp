...
import { ApiOperation, ApiBody, ApiResponse, ApiTags, ApiOkResponse, ApiNotFoundResponse, ApiParam } from '@nestjs/swagger';
...
export class UsersController {
  ...
  async registerUser(@Body() createUserDto: CreateUserDto): Promise<{ user: CreateUserDto; verificationToken: string }> {
  ...
  getProfile(@Req() req): User {
    // The user is available in req.user, which was set by Passport
    return req.user;
  }
}
